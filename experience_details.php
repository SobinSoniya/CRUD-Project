...
<!--start of header name-->
 <h1 class="h3 mb-4 text-gray-800">Experience Details Setting</h1>
 <!--end of header name-->
        <?php
...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `experience_details`(`user_code`, `organization_name`, `experience`, `role`) VALUES ('$user_code','$organization_name','$experience','$role')";  
